...
class colorGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        colorView.setImageResource(com.appproject.tnrkd.colormakey.R.drawable.mask);
...
//-------------------------컬러 그리드 생성-------------------------------------------------
        ...
        colorPreview.setImageResource(com.appproject.tnrkd.colormakey.R.drawable.mask);
