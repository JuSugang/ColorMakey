...
public class RemixerPopupActivity extends Activity {
    ...
    public void AddValuesToPieEntryLabels(ArrayList<com.appproject.tnrkd.colormakey.dto.Color> color){
...
//            test.minimize(3000, (float)0.00001);
        ...
        protected void onPostExecute(String result) {
            ...
            dialog.dismiss();
            dialog=null;
            ArrayList<com.appproject.tnrkd.colormakey.dto.Color> result_Color=test.getColor();
